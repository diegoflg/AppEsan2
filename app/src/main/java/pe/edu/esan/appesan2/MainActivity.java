...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      if (fila1.moveToFirst()) {
        ...
        //Se crea una base de datos del tipo de HorarioBD
        HorarioBD adminH = new HorarioBD(this, "BDHORARIO1", null, 1);

        //Se permite la lectura y escritura en la base de datos
        SQLiteDatabase bdH = adminH.getWritableDatabase();

        //Se crea el cursor de la base
        Cursor c = bdH.rawQuery("SELECT usuario FROM Horario", null);

        if(c.moveToFirst())
        {   }else{

            //Se crean cadenas de textos y se les determina un valor para cada campo de la BD
            ...
            //Se crea un nuevo contenedor de valores
            ContentValues rH0 = new ContentValues();

            //Se guardan los valores en cada campo
        ...
        //Se crea una base de datos del tipo PagosBD
        ...
        //Se crea un cursos y se le da un valor
        ...
        {   //Toast t = Toast.makeText(this, "hay datos pagos", Toast.LENGTH_SHORT);
            ...
            //Se declaran textos y se les da un valor
            ...
            //Se dan los valores a los campos de  la BD
